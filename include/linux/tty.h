...
struct tty_port {
	...
	const struct tty_port_client_operations *client_ops; /*tty port client operations (like receive_buf, write_wakeup). */
	...
	void			*client_data;	/* pointer to private data, for @client_ops*/
};
